...
class AddForumReview extends StatefulWidget {
  const AddForumReview({Key? key, required this.casinoDetail})
      : super(key: key);

  final CasinoDetails casinoDetail;

  @override
  _AddForumReviewState createState() => _AddForumReviewState();
}

class _AddForumReviewState extends State<AddForumReview> {
