...
class AddRestaurantStarDialogBoxDirect extends StatefulWidget {
  const AddRestaurantStarDialogBoxDirect({
    Key? key,
  ...
  @override
  _AddRestaurantStarDialogBoxDirectState createState() =>
      _AddRestaurantStarDialogBoxDirectState();
}

class _AddRestaurantStarDialogBoxDirectState
    extends State<AddRestaurantStarDialogBoxDirect> {
  ...
  void _addReview() async {
    ...
    _reviewController
        .addRestaurantReview(
            widget.restaurantReviewResponsehotelData.restaurantId,
            widget.restaurantReviewResponsehotelData.restaurantName,
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            widget.restaurantReviewResponsehotelData
                                .restaurantName,
                            style: const TextStyle(
