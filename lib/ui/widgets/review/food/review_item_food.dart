...
import 'package:casino/ui/widgets/review/food/add_food_star_dialog_box_direct.dart';
import 'package:flutter/material.dart';
import 'package:flutter_rating_bar/flutter_rating_bar.dart';
import 'package:get/get_utils/src/extensions/internacionalization.dart';

class ReviewItemFood extends StatelessWidget {
  const ReviewItemFood({
    Key? key,
            ...
            onTap: () {
              showDialog(
                  ...
                  builder: (BuildContext context) {
                    return AddFoodStarDialogBoxDirect(
                      casinoDetail: casinoDetail,
                      hotelData: hotelData,
                      address: hotelData.hotelLocation,
                    );
                  });
            },
            child: Container(
