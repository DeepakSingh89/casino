...
class AddFoodStarDialogBox extends StatefulWidget {
  const AddFoodStarDialogBox({
    Key? key,
  ...
  @override
  _AddFoodStarDialogBoxState createState() => _AddFoodStarDialogBoxState();
}

class _AddFoodStarDialogBoxState extends State<AddFoodStarDialogBox> {
  ...
  void _addReview() async {
    ...
    _reviewController
        .addHotelReview(
            widget.hotelDetails.hotelId,
            widget.hotelDetails.hotelName,
