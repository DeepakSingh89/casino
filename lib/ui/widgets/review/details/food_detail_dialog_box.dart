...
class FoodDetailDialogBox extends StatefulWidget {
  const FoodDetailDialogBox({Key? key, required this.restaurantData})
      : super(key: key);

  final RestaurantData restaurantData;

  @override
  _FoodDetailDialogBoxState createState() => _FoodDetailDialogBoxState();
}

class _FoodDetailDialogBoxState extends State<FoodDetailDialogBox> {
  List imgList = [];

  items(BuildContext context, Size screenSize) {
    for (var element in widget.restaurantData.restaurantImage) {
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: RatingBar.builder(
                    initialRating: widget.restaurantData.rating.toDouble(),
                    minRating: widget.restaurantData.rating.toDouble(),
                    updateOnDrag: false,
                        ...
                        child: CircleAvatar(
                          ...
                          child: CircleAvatar(
                            ...
                            backgroundImage: Image.network(
                              Utility.getImageUrl(
                                  widget.restaurantData.userPicId,
                                  widget.restaurantData.userPicVersion),
                ...
                widget.restaurantData.restaurantImage.isEmpty
                    ? Text("")
                    : Container(
                        alignment: Alignment.center,
