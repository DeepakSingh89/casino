...
class HotelDetailDialogBox extends StatefulWidget {
  const HotelDetailDialogBox({Key? key, required this.hotelData})
      : super(key: key);
  final HotelData hotelData;

  @override
  _HotelDetailDialogBoxState createState() => _HotelDetailDialogBoxState();
}

class _HotelDetailDialogBoxState extends State<HotelDetailDialogBox> {
  List imgList = [];

  items(BuildContext context, Size screenSize) {
    for (var element in widget.hotelData.hotelImage) {
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: RatingBar.builder(
                    initialRating: widget.hotelData.rating.toDouble(),
                    minRating: widget.hotelData.rating.toDouble(),
                    updateOnDrag: false,
                        ...
                        child: CircleAvatar(
                          ...
                          child: CircleAvatar(
                            ...
                            backgroundImage: Image.network(
                              Utility.getImageUrl(widget.hotelData.userPicId,
                                  widget.hotelData.userPicVersion),
                ...
                widget.hotelData.hotelImage.isEmpty
                    ? Text("")
                    : Container(
                        alignment: Alignment.center,
