class CasinoForumResponse {
  ...
  late final List<Forums> forums;

  CasinoForumResponse.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    forums = List.from(json['forums']).map((e) => Forums.fromJson(e)).toList();
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['forums'] = forums.map((e) => e.toJson()).toList();
    return _data;
  }
}
